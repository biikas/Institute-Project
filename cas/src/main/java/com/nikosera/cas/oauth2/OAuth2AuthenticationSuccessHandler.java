...
import com.nikosera.cas.config.properties.AppProperties;
import com.nikosera.cas.exception.BadRequestException;
import com.nikosera.cas.util.CookieUtils;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    @Autowired
    OAuth2AuthenticationSuccessHandler(TokenBuilder tokenProvider, AppProperties appProperties,
                                       HttpCookieOAuth2AuthorizationRequestRepository httpCookieOAuth2AuthorizationRequestRepository) {
        this.tokenBuilder = tokenProvider;
