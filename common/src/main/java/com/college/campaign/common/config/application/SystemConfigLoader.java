...
import com.college.campaign.repository.SystemConfigMasterRepository;
...
public class SystemConfigLoader {
    ...
    private Map<String, String> convertToServiceMap(SystemConfigMaster systemConfigMaster) {
        return systemConfigMaster.getSystemConfigs()
                ...
                .collect(Collectors.toMap(com.college.campaign.entities.model.SystemConfig::getParamCode, com.college.campaign.entities.model.SystemConfig::getParamValue));
    }
