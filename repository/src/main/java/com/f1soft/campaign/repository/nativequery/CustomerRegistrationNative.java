package com.f1soft.campaign.repository.nativequery;

import com.f1soft.campaign.dto.QueryCriteria;
import com.f1soft.campaign.dto.RegistrationReportDetail;
import com.f1soft.campaign.repository.Util.FieldQueryParameter;
import com.f1soft.campaign.repository.Util.QueryFormatter;
import com.f1soft.campaign.repository.Util.QueryHelper;
